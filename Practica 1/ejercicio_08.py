...
def superposicion_set(lista_1: Iterable[Any], lista_2: Iterable[Any]) -> bool:
    ...
    #En esta función, se convierten las listas en conjuntos utilizando la función incorporada set(),
    #  que elimina duplicados y crea un conjunto desordenado de elementos únicos.
    # 
    # class set([iterable])
    ...
    print(primer_set)
    print(segundo_set)
    print(primer_set.intersection(segundo_set))
    set_resultado = primer_set.intersection(segundo_set)
    print(len(set_resultado) > 0)
